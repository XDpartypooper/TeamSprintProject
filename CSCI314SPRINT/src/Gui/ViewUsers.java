...
public class ViewUsers extends javax.swing.JFrame {
     ...
     */
    public ViewUsers(String name,String ID) throws SQLException {
        this.name =name;
        this.ID =ID;  
        initComponents();
        ...
        refreshSearch("");                    
            ...
            {
                jComboBox2.addItem(al.get(i).ReturnProfileType());
            }    
    }
        ...
        try {
            ...
            {   
               ...
               if(a==JOptionPane.YES_OPTION)
                {
                    //final delete
                    boolean check = SAC.DelAccCon(ID);//delete USER
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        String word=null;     
        PT = jComboBox2.getSelectedItem().toString();//get profiletype         
    ...
    public void refreshSearch(String word)
    {
     try {
         //PT
            ...
            ArrayList<UserProfile> al = SAC.ViewAccCon(word,PT);
            for (int i=0; i< al.size();i++)
            {
