...
public class ProfileTypeView extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JFrame  f=new JFrame();
            ...
            int n = JOptionPane.showConfirmDialog(null, myPanel,"Please Enter Name of new Profile Type ", JOptionPane.OK_CANCEL_OPTION);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            if (CHECK==true)
            {
                ...
                int n = JOptionPane.showConfirmDialog(null, myPanel,"Please Enter data of updated user profile " , JOptionPane.OK_CANCEL_OPTION);
