...
public class SystemAdminMenu extends javax.swing.JFrame {
     ...
     */
    public SystemAdminMenu(String name,String ID) {
        this.name =name;
        this.ID =ID;  
        initComponents();
        jLabel1.setText("System Admin - User: "+name);
    ...
    private void initComponents() {
        ...
        jButton4.setText("User Profiles");
